...
namespace vindinium
{
    class ServerStuff
    {
        ...
        public List<Tavern> taverns { get; private set; } 
                    ...
                    case '$':
                        switch (charData[i + 1])
                        {
                            case '-':
                                ...
                                mines.Add(new Mine(y,x, 0));
                                break;
                            case '1':
                                board[x][y] = Tile.GOLD_MINE_1;
                                mines.Add(new Mine(y,x, 1));
                                break;
                            case '2':
                                board[x][y] = Tile.GOLD_MINE_2;
                                mines.Add(new Mine(y,x, 2));
                                break;
                            case '3':
                                board[x][y] = Tile.GOLD_MINE_3;
                                mines.Add(new Mine(y, x, 3));
                                break;
                            case '4':
                                board[x][y] = Tile.GOLD_MINE_4;
                                mines.Add(new Mine(y, x, 4));
                                break;
                        }
                        break;
                }
